...
#SBATCH --output=/camcan/FPNflexiblehubs/FPNflexiblehubs/lost_res/camcan/slurm-%j.out
#SBATCH --error=/camcan/FPNflexiblehubs/FPNflexiblehubs/lost_res/camcan/slurm-%j.err
